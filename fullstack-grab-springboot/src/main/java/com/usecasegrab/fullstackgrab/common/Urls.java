...
public class Urls {
    ...
    public static final String UPDATE_ORDER = ORDERS_BASE + "/updated/";
    public static final String GET_ORDER = ORDERS_BASE + "/";
    public static final String GET_ORDER_BY_ID = ORDERS_BASE + "/{orderId}";
